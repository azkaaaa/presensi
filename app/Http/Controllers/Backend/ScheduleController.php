...
class ScheduleController extends Controller
{
    ...
    { 
      $years = DB::table('genetic_schedule')
      ->select('genetic_schedule.year')
            ->groupBy('genetic_schedule.year')
            ->orderBy('genetic_schedule.year', 'desc')
            ->get();

      $schedule = DB::table('genetic_schedule')
            ->join('months', 'months.id', '=', 'genetic_schedule.month_id')
            ->select('months.name as month_name', 'genetic_schedule.*')
            ->groupBy('genetic_schedule.month_id')
            ->groupBy('genetic_schedule.year')
            ->orderBy('genetic_schedule.created_at', 'desc')
            ->get();
 ...
 //  	}
  	...
  	{	
        ...
        $date = $dt->toDateString();
    	 ...
    	 $schedules = DB::table('genetic_schedule')
            ...
            ->join('days as days_three', 'days_three.id', '=', 'genetic_schedule.third_week')
            ->join('days as days_four', 'days_four.id', '=', 'genetic_schedule.fourth_week')
            ->select('genetic_schedule.*', 'employees.name as employee_name', 'months.name as month_name', 'shifts.name as shift_name', 'days.name as first_week_name', 'days_two.name as second_week_name', 'days_three.name as third_week_name', 'days_four.name as fourth_week_name')
    ...
    {   
      ...
      $list_schedule = GeneticSchedule::latest()->first();
    ...
    { 
      ...
      $schedule = DB::table('genetic_schedule')
            ...
            ->join('days as days_four', 'days_four.id', '=', 'genetic_schedule.fourth_week')
            ->select('genetic_schedule.*', 'employees.name as employee_name', 'shifts.name as shift_name', 'days.name as first_week_name', 'days_two.name as second_week_name', 'days_three.name as third_week_name', 'days_four.name as fourth_week_name')
            ->where('genetic_schedule.list', '=', $history)
            ->orderBy('genetic_schedule.employee_id', 'asc')
            ->get();

      $spec_schedule = DB::table('genetic_schedule')
            ->join('months', 'months.id', '=', 'genetic_schedule.month_id')
            ->select('genetic_schedule.*', 'months.name as month_name')
            ->where('genetic_schedule.list', '=', $history)
            ->first();
