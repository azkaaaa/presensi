...
class GeneticVero {
    ...
    {    
        ...
        for ($i = 0; $i < $this->populasi; $i++) {
            ...
            for ($j = 0; $j < $all_employee; $j++) {
                ...
                $this->individu[$i][$j][2] = mt_rand(0, $all_shift - 1);

                // Penentuan hari secara acak 
                $this->individu[$i][$j][3] = mt_rand(0, $all_shift - 1);

                // Penentuan hari secara acak 
                $this->individu[$i][$j][4] = mt_rand(0, $all_shift - 1);

                // Penentuan shift secara acak 
                $this->individu[$i][$j][5] = mt_rand(0, $all_day - 1);
    ...
    private function CekFitness($indv)
    {
        ...
        for ($i = 0; $i < $all_employee; $i++)
        {
          ...
          $off_a = intval($this->individu[$indv][$i][5]);          
            ...
            for ($j = 0; $j < $all_employee; $j++) {                 
                ...
                $off_b = intval($this->individu[$indv][$j][5]);
    ...
    public function Mutasi()
    {
        ...
        for ($i = 0; $i < $this->populasi; $i++) {
            ...
            if ($r < $this->mutasi) {
                ...
                $this->individu[$i][$krom][2] = mt_rand(0, $all_shift - 1);

                $this->individu[$i][$krom][3] = mt_rand(0, $all_shift - 1);

                $this->individu[$i][$krom][4] = mt_rand(0, $all_shift - 1);

                $this->individu[$i][$krom][5] = mt_rand(0, $all_day - 1);
    ...
    public function GetIndividu($indv)
    {
        ...
        for ($j = 0; $j < count($this->employee); $j++)
        {
            ...
            $individu_solusi[$j][2] = intval($this->shift[$this->individu[$indv][$j][2]]);       
            $individu_solusi[$j][3] = intval($this->shift[$this->individu[$indv][$j][3]]);       
            $individu_solusi[$j][4] = intval($this->shift[$this->individu[$indv][$j][4]]);       
            $individu_solusi[$j][5] = intval($this->day[$this->individu[$indv][$j][5]]);       
        }
        // dd($individu_solusi);
