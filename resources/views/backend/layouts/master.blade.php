...
<head>
  ...
  <!-- Datatable -->
  <link rel="stylesheet" href="{{ URL::asset('admin/dist/css/jquery.dataTables.min.css') }}">
  ...
  <!-- Jquery JS -->
  <script src="{{ URL::asset('admin/dist/js/jquery-1.10.2.min.js') }}"></script>
...
<!-- Datatable JS -->
<script src="{{ URL::asset('admin/dist/js/jquery.dataTables.min.js') }}"></script>
<script>
