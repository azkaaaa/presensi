        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form Konfirmasi Buat Gaji Bulan Ini</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{url('/admin/salary')}}" class="form-horizontal">
              ...
              <div class="box-footer">
                <button class="btn-default btn" type="reset" onclick="window.location='{{ url('/admin/salary')}}'">Kembali</button>
