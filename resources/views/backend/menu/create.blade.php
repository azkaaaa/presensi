  ...
  <div class="col-md-11">
    <div class="box box-info">
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><b>Form Tambah Menu</b></h3>
      </div>

      <form method="POST" action="{{url('/admin/menu')}}" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="form-group {{($errors->has('name')?'has-error':'')}}">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Nama Menu" name="name">
